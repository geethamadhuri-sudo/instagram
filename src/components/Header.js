                          ...
                          {user ? (
                              ...
                              <Link to ={ROUTES.DASHBOARD} aria-label="Dashboard">
                                <svg
                                    ...
                                    stroke="currentColor">
                                        ...
                                        1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 
                              ...
                              <>
                                    <Link to={ROUTES.LOGIN}>
                                        <button type="button" className="bg-blue-medium font-bold text-sm 
                                            rounded text-white w-20 h-8">Log In</button>
                                    </Link>
                                    <Link to={ROUTES.SIGN_UP}>
                                        <button type="button" className="font-bold text-sm rounded text-blue-medium h-8 w-20">Sign Up</button>
                                    </Link>
                              </>
                          )
                          }
